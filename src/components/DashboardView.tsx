...
import { Users, Calendar, Utensils, Plus, Activity, CheckCircle2, TrendingUp, ShieldCheck, Crown, Sparkles, Stethoscope, UserCheck, Flame, HeartPulse } from 'lucide-react';
...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <div>
            ...
            <h2 style={{ fontSize: '1.8rem', fontWeight: 800, color: '#ffffff', marginBottom: '6px' }}>
              {isMaster ? 'Painel Executivo Master — Vagner Nutri' : 'Painel Clínico — Vagner Nutri'}
            </h2>
      ...
      {/* Metrics Cards: AZUL (Pacientes), VERDE (Consultas), VERMELHO (Planos/Metas) */}
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
        ...
        {/* Card 4: Equipe Médica / Master */}
        {isMaster && (
          <div className="glass-panel glass-panel-hover" style={{ padding: '24px', borderTop: '3px solid #f59e0b' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              <span style={{ fontSize: '0.875rem', fontWeight: 600, color: '#94a3b8' }}>Nutricionistas da Equipe</span>
        ...
        <div className="glass-panel" style={{ padding: '28px', border: '1px solid rgba(245, 158, 11, 0.25)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '16px' }}>
            {nutrisList.map((nutri, index) => {
              ...
              // Alternating Triad Gradients for doctors
              const gradList = [
